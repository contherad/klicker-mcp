...
def test_rejects_oauth_client_secret_as_ga(credentials_dir: Path, write_credentials):
    ...
    write_credentials("google-analytics-credentials.json", {
        "installed": {
...
def test_health_check_passes_when_all_present(credentials_dir, write_credentials, sample_service_account):
    ...
    write_credentials("google-ads-credentials.json", {
        "developer_token": "DEV",
        "client_id": "CID",
        "client_secret": "CSEC",
        "refresh_token": "RTOK",
...
def test_hot_reload_picks_up_new_files(credentials_dir, write_credentials, sample_service_account, monkeypatch):
